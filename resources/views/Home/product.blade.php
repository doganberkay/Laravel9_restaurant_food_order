                ...
                <div class="col-md-5">
                    ...
                    <div class="carousel slide" data-ride="carousel" id="carousel-1">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"><img class="" style="height:400px; width:500px; object-fit: contain" src="{{Storage::url($data->image)}}" alt="Slide Image" loading="lazy"></div>
                            @foreach($images as $rs)
                            <div class="carousel-item"><img style="height:400px; width:500px; object-fit: contain"  src="{{Storage::url($rs->image)}}" alt="Slide Image"></div>
                                @if(is_null($rs->image))
